...
def mk_limit(fname="",m=-1,minm=-1,maxm=-1,hname="",xtitle="",rebin=1):
  ...
  for g in [3.5,3.0,2.5,2.0,1.7,0.7,0.5,0.2]:
    h1_alp.Scale(g*g)
    ...
    cls.append(myconfidence.GetExpectedCLs_b())
    print(myconfidence.GetExpectedCLs_b())
...
for mc in list_mc:
  ...
  mk_limit(inputdir+"/MC_"+mc+"/plots.root",list_mass[mc],0,12.,"h1_digammaM","M (#gamma#gamma) [GeV]",40)
  i=i+1
